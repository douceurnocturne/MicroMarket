        ...
        <div id="#home">
            ...
            <form method="post">
                ...
                <div class="col-3">
                    <label>
                        Quantity
                        <input type="number" required placeholder="Min: 1, Max: " min="1" max="5" id="quantity" name="quantity" tabindex="3">
                    </label>
                </div>
                <div class="col-3">
                    <label>
                        Shipping Cost
                        <input type="number" required name="shipping_cost" tabindex="4">
                    </label>
                </div>
                <div class="col-i">
                    <label>
                        ...
                        <input id="product" name="selectedProduct" type="hidden" value=${productlist[0]}>
